...
### Die Erstellung eines FRS Smart Contracts mit C#
...
Dieser Abschnitt enthält ein kurzes Tutorial, das die Konfiguration eines C# Entwicklungsumfeldes für FRS Smart Contracts erklärt und die grundlegende Idee der ​​Erstellung und Kompilierung eines Smart Contract Projekts vermittelt. 

Anmerkung: Aktuell wurden alle Projekte auf Visual Studio 2017 upgegradet. Wenn Sie Visual Studio 2015 verwenden möchten um Smart Contracts zu erstellen, dann lesen sie bitte, [wie man C# in VS2015 verwenden kann, um FRS Smart Contracts zu erstellen](https://github.com/FRS-project/docs/blob/master/en-us/sc/getting-started-2015.md) 
...
Die Installation ist äußerst einfach, folgen Sie einfach den Schritt-für-Schritt Anweisungen. Bitte beachten Sie, dass die Installation von .Net Cross-Plattorm Entwicklung ausgewählt werden muss, da Sie sonst FRS-vm project in Schritt #3 nicht öffnen können. Die Installation dauert zwischen 10 Minuten und einer Stunde. 
...
Öffnen Sie Visual Studio 2017, wählen Sie Tools aus, klicken Sie auf Erweiterungen und Updates, klicken Sie auf den Online Tab auf der linken Seite, suchen Sie FRS in dem Suchfeld in der rechten oberen Ecke und downloaden Sie FRSContractPlugin (Internetverbindung erforderlich).
...
Downloaden Sie das [FRS-compiler](https://github.com/FRS-project/FRS-compiler) Projekt auf Github, öffnen Sie den Solution Explorer in Visual Studio 2017 und veröffentlichen Sie das FRSn Projekt. 
 
![publish FRS compiler msil project](/assets/publish_FRS_compiler_msil_project.png)

![publish and profile settings](/assets/publish_and_profile_settings.png)
 
Nach erfolgter Veröffentlichung wird das FRSn.exe File in `bin\Release\PublishOutput` generiert.
...
Starten Sie die Kommandozeile oder PowerShell und geben FRSn.exe ein. Wenn keine Fehlermeldung erscheint und die Version Nummer angezeigt wird, dann war die Konfiguration der Umgebungsvariable erfolgreich. 
...
Nach erfolgter Installation können Sie ein neues FRSContract Projekt in Visual Studio 2017 erstellen.
...
Nachdem die Kompilierung erfolgreich war, wird im bin/Debug Verzeichnis SmartContract1.avm angezeigt, was das generierte FRS Smart Contract File darstellt. 

![compile smart contract](/assets/compile_smart_contract.png)
 
Da die Konfiguration des FRS Smart Contract Entwicklungsumfeldes nun abgeschlossen ist, öffnen Sie nun bitte das [FRS Smart Contract Tutorial](https://github.com/FRS-project/docs/blob/master/en-us/sc/tutorial.md) 
