...
Este método transmite una transación a través de la red FRS. Existen muchos tipos de transacciones tal y como se especifica en la documentación del [protocolo de red](../network-protocol.md). 
