...
首先用 Visual Studio 创建一个 C# 控制台项目，设置 .net framework 版本中 4.6.2 或以上，并且在 Nuget 中添加对 FRS.dll 和 FRS.VM.dll 的引用。
...
该文档正在编辑中，我们会尽快完成，你可以在 [Github wiki](https://github.com/FRS-project/FRS/wiki) 上查看其它文档，或者来我们的 [FRS 官方网站](http://www.FRS.org) 逛逛。

FRS 是一个开源的社区项目，如果你感兴趣，你也可以通过 pull request 的方式来贡献开发文档，开发文档的项目地址为 [github.com/FRS-project/docs](https://github.com/FRS-project/docs) ，感谢您的付出。
